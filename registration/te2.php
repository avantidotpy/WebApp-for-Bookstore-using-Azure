...
<li class="dropdown">
  ...
  <img src="img/te2.jpg" alt="HTML5 Icon" width="200" height="300" class="center">
...
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>Database System Concepts</label>
    </div>
     <div class="input-group">
      <label> Author : S.Sundaram</label>
    </div>
     <div class="input-group">
    ...
    <div class="input-group">
      <label>Book Id: 69</label>
      
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_te2" >
