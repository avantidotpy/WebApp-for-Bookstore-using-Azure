...
<li class="dropdown">
  ...
  <img src="img/te1.jpg" alt="HTML5 Icon" width="200" height="300" class="center">
...
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>Microprocessors and Microcontrollers</label>
    </div>
     <div class="input-group">
      <label>Author: Sunil Mathur</label>
    </div>
     <div class="input-group">
      <label> PRICE:  400</label>
    </div>
    <div class="input-group">
      <label>Book Id: 68</label>
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_te1" >
