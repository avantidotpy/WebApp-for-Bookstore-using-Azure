...
<li class="dropdown">
  ...
  <img src="img/be3.jpg" alt="HTML5 Icon" width="200" height="300" class="center">


<p>
 <a href="BE.php"><i class=" w3-xxxlarge fa fa-hand-o-left icon color" style="position: absolute;top: 60px;right:10px;" aria-hidden="true"></i></a>
</p>

<div class="koho">
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>Advances and Application of Optimized Algorithm in Image Processing</label>
    </div>
     <div class="input-group">
      <label> Author : Deigo Olive</label>
    </div>
     <div class="input-group">
    ...
    <div class="input-group">
      <label>Book Id: 75</label>
      
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_be3" >
