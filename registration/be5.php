...
<li class="dropdown">
  ...
  <img src="img/be5.jpg" alt="HTML5 Icon" width="200" height="300" class="center">
...
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>MAC OSX: Complete Reference</label>
    </div>
     <div class="input-group">
      <label> Author : Jesse Feiler</label>
    </div>
     <div class="input-group">
    ...
    <div class="input-group">
      <label>Book Id: 77</label>
      
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_be5" >
