...
<li class="dropdown">
  ...
  <img src="img/te4.jpg" alt="HTML5 Icon" width="200" height="300" class="center">


<p>
 <a href="TE.php"> <i class=" w3-xxxlarge fa fa-hand-o-left icon color" style="position: absolute;top: 60px;right:10px;" aria-hidden="true"></i></a>
</p>

<div class="koho">
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>Data and Computer Communications</label>
    </div>
     <div class="input-group">
      <label> Author : William Stallings</label>
    </div>
     <div class="input-group">
      <label> PRICE:  1500</label>
    </div>
   
    <div class="input-group">
      <label>Book Id: 71</label>
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_te4" >
