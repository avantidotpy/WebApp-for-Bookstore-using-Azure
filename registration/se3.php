...
<li class="dropdown">
  ...
  <img src="img/se3.jpg" alt="HTML5 Icon" width="200" height="300" class="center">
...
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>Modern Digital Electronics</label>
    </div>
     <div class="input-group">
      <label> Author : R.P.Jain</label>
    </div>
     <div class="input-group">
    ...
    <div class="input-group">
      <label>Book Id: 65</label>
      
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_se3" >
