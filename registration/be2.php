...
<li class="dropdown">
  ...
  <img src="img/be2.jpg" alt="HTML5 Icon" width="200" height="300" class="center">
...
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>ASP.NET:Complete Reference</label>
    </div>
     <div class="input-group">
      <label> Author : Matthew</label>
    </div>
     <div class="input-group">
      <label> PRICE:  650</label>
    </div>
   
    <div class="input-group">
      <label>Book Id: 74</label>
      
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_be2" >
