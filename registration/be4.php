...
<li class="dropdown">
  ...
  <img src="img/be4.jpg" alt="HTML5 Icon" width="200" height="300" class="center">


<p>
  <a href="koho"><i class=" w3-xxxlarge fa fa-hand-o-left icon color" style="position: absolute;top: 60px;right:10px;" aria-hidden="true"></i></a>
</p>

<div class="koho">
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>Electronic Circuits and Analysis Design</label>
    </div>
     <div class="input-group">
      <label> Author : Donald A Neaman</label>
    </div>
     <div class="input-group">
      <label> PRICE:  450</label>
    </div>
   
    <div class="input-group">
      <label>Book Id: 76</label>
      
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_be4" >
