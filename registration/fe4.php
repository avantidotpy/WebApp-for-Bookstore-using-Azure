...
<li class="dropdown">
  ...
  <img src="img/fe4.jpg" alt="HTML5 Icon" width="200" height="300" class="center">
...
<form class=form2 action="ordermain.php" method=post>
  <div class="input-group">
      <label>Engineering Physics</label>
    </div>
     <div class="input-group">
      <label> Author : S.K.Tiwary</label>
    </div>
     <div class="input-group">
    ...
    <div class="input-group">
      <label>Book Id: 61</label>
      
    </div>

    <div class="input-group">
      <input type="submit" value="Order" class="btn" name="submit_user_fe4" >
