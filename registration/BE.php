...
<div class="koho bookimages">
  ...
  <div class="gallery">
  <a target="_blank" href="be3.php">
    <img class="books" src="img/be3.jpg"  width="600" height="400">
  </a>
  <div class="desc">Rs.600</div>
  </div>

  <div class="gallery">
  <a target="_blank" href="be4.php">
    <img class="books" src="img/be4.jpg" width="600" height="400">
  </a>
  <div class="desc">Rs.400</div>
  </div>

  <div class="gallery">
  <a target="_blank" href="be5.php">
    <img class="books" src="img/be5.jpg"  width="600" height="400">
  </a>
  <div class="desc">Rs.400</div>
  </div>

  <div class="gallery">
  <a target="_blank" href="be6.php">
    <img class="books" src="img/be6.jpg"  width="600" height="400">
  </a>
  <div class="desc">Rs.400</div>
  </div>
